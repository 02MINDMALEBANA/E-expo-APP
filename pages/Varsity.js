  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.addressDetails}>
        ...
        <Text style={styles.address}>Physical	Cnr Kingsway & University Roads,
 Auckland Park, Johannesburg, 2092 </Text>
 <Text>Tel	011 559 4555</Text>
 <Text>Web	www.uj.ac.za</Text>
