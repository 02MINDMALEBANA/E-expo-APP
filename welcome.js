  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={{fontSize:32,fontWeight:500}}>WELCOME!</Text>
       ...
       <Text style={{fontSize:32,fontWeight:500,marginTop:200}}>WELCOME!</Text>
       <View>
       <Image
        source={require('./assets/learner.webp')}
      ...
      <View style={styles.log}>
        ...
        <TouchableOpacity>
          <View style={styles.sign}>
            <Text style={{color:'white',marginLeft:20,marginTop:10,fontSize:16,fontWeight:700}}>APS</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity>
          <View style={styles.sign1}>
            <Text style={{color:'white',marginLeft:20,marginTop:10,fontSize:10,fontWeight:700}}>Resume Guide</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity>
